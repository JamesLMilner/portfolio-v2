class Noise {
  ...
  generate(x, y, z) {
    ...
    const a = this.lerp(
                ...
                this.lerp(
                  u, 
                  this.lerp(this.p[AB], x, yMinus1, z),
                  this.lerp(this.p[BB], xMinus1, yMinus1, z)  
                )
              );
    ...
    const b = this.lerp(
                ...
                this.lerp(
                  u, 
                  this.lerp(this.p[AA + 1], x, y, zMinus1),
                  this.lerp(
                    this.p[BA + 1], 
                    xMinus1, 
                    y, 
                ...
                this.lerp(
                  u, 
                  this.grad(this.p[AB + 1], x, yMinus1, zMinus1),
                  this.grad(this.p[BB + 1], xMinus1, yMinus1, zMinus1)
                )
              );

    return  this.lerp(w, a, b);
